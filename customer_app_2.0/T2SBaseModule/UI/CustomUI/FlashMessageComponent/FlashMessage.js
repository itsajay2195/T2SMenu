...
export const renderFlashMessageIcon = (icon = 'success', style = {}, customProps = {}) => {
    switch (icon) {
        case 'success':
            return <Image style={[styles.flashIcon, style]} source={require('./icons/fm_icon_success.png')} {...customProps} />;
        case 'info':
            return <Image style={[styles.flashIcon, style]} source={require('./icons/fm_icon_info.png')} {...customProps} />;
        case 'warning':
            return <Image style={[styles.flashIcon, style]} source={require('./icons/fm_icon_warning.png')} {...customProps} />;
        case 'danger':
            return <Image style={[styles.flashIcon, style]} source={require('./icons/fm_icon_danger.png')} {...customProps} />;
        default:
            return null;
    }
};
