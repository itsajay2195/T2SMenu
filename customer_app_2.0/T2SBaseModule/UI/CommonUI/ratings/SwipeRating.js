...
import { View, Text, Animated, PanResponder, Image, StyleSheet, ViewPropTypes } from 'react-native';
import Colors from '../../../Themes/Colors';
import { FONT_FAMILY } from '../../../Utils/Constants';
import { setFont } from '../../../Utils/ResponsiveFont';

// RATING IMAGES WITH STATIC BACKGROUND COLOR (white)
const STAR_IMAGE = require('./images/star_new.png');
...
export default class SwipeRating extends Component {
    static defaultProps = {
        type: 'star',
        ratingImage: require('./images/star_new.png'),
        ratingColor: Colors.gold,
        ratingBackgroundColor: Colors.ashColor,
        ratingCount: 5,
        imageSize: 40,
        onFinishRating: () => {},
        minValue: 0
