...
public class PaymentsUtil {
  //This calls info is provided by google and made available for reference in the google pay official docs.
...
JSONObject cardPaymentMethod = new JSONObject();
    ...
    billingAddress.put("format", "FULL");
    parameters.put("billingAddressParameters", billingAddress);
